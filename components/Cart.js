                            ...
                            state.selectItems.map((item)=>{
                                return(
                                    <div className={styles.productCartSect} key={item.id}>
                                        ...
                                        <img src={item.image} />
                                        <h2>{item.title.length>15 ? item.title.substring(0,20):item.title}</h2>
                                        <span>{item.price} $</span>
                                        </div>
                                        <div className="CardButtons">
                                        <CardButtons counter={item} state={state} dispatch={dispatch}/>
                                        </div>
                                    </div>
                                )
                            })}
                ...
                (
                    <div className={styles.CartMessages}>
                        {state.checkout ?
                            (
                            <>
                            <h2 className={theme.DarkMode? styles.CartMessagesTitle:''}>Thanks For Your Shopping</h2>
                            ...
                            (
                            <>
                            <h2 className={theme.DarkMode? styles.CartMessagesTitle:''}>Your Cart Is Empty</h2>
                            <Link href='/'>Shop</Link>
                            </>
                            )
                        }
